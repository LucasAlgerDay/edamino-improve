...
class ChatExtensions(BaseModel):
    ...
    organizerTransferRequest: Optional[OrganizerTransferRequest]

class OrganizerTransferRequest(BaseModel):
    createdTime: Optional[str]
